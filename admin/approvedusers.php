...
if(isset($_GET['sort'])){
  ...
  $obj = new Users();
  $db = new config();
  $final = $obj->sort_pending_users($sort, $order, '1', $db->conn);
  // echo $final;
  // die();
}
?>
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
          ...
          <li>
            ...
            <a class="active" href='approvedusers.php'>Approved User Requests</a>
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center">
                      UserName
                      <a href="approvedusers.php?sort=ASC&val=user_name"><p class="caret"></p></a>
                      <a href="approvedusers.php?sort=DESC&val=user_name"><p class="caret caret-dropup"></p></a>
                    </th>
                    <th class="text-center">
                      Name
                      <a href="approvedusers.php?sort=ASC&val=name"><p class="caret"></p></a>
                      <a href="approvedusers.php?sort=DESC&val=name"><p class="caret caret-dropup"></p></a>
                    </th>
                    <th class="text-center">
                      Mobile
                      <a href="approvedusers.php?sort=ASC&val=mobile"><p class="caret"></p></a>
                      <a href="approvedusers.php?sort=DESC&val=mobile"><p class="caret caret-dropup"></p></a>
                    </th>
            ...
            <?php
                if(isset($_GET['sort'])) {
                  $sql = $final; 
                    ...
                    $users = new Users();
                    $db = new config();
                    $sql = $users->select_pending_users('1', $db->conn);
                }
                $i = 1;
                foreach($sql as $data){
                $id = $data['user_id'];
