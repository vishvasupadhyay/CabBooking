...
if(isset($_GET['sort'])){
  ...
  $obj = new Rides();
  $db = new config();
  $final = $obj->sort_past($sort, $order, $db->conn);
  // echo $final;
  // die();
}
?>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center">
                          Date
                          <a href="pastrides.php?sort=ASC&val=ride_date"><p class="caret"></p></a>
                          <a href="pastrides.php?sort=DESC&val=ride_date"><p class="caret caret-dropup"></p></a>
                        </th>
                        <th class="text-center">From</th>
                        <th class="text-center">To</th>
                        <th class="text-center">
                          Total Distance
                          <a href="pastrides.php?sort=ASC&val=total_distance"><p class="caret"></p></a>
                          <a href="pastrides.php?sort=DESC&val=total_distance"><p class="caret caret-dropup"></p></a>
                        </th>
                        <th class="text-center">Luggage</th>
                        <th class="text-center">
                          Total Fare
                          <a href="pastrides.php?sort=ASC&val=total_fare"><p class="caret"></p></a>
                          <a href="pastrides.php?sort=DESC&val=total_fare"><p class="caret caret-dropup"></p></a>
                        </th>
                ...
                <?php
                    if(isset($_GET['sort'])) {
                      $sql = $final; 
                        ...
                        $rides = new Rides();
                        $db = new config();
                        $sql = $rides->select_confirmed_ride($db->conn);
                    }
                    $i = 1;
                        foreach($sql as $data){
                            ?>
                                <tr>
                                    ...
                                    <td><a href="invoice.php?id=<?php echo $data['ride_id']; ?>" class="btn btn-success btn-xs">Print Invoice</a></td>
                                </tr>
                            <?php
                    }
                ?>
